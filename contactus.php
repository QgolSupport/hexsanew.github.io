...
function send_sms(){	
	...
	if( from == ""){
	alert("Pls. Enter your Contact no");
	}else if( message == ""){
    ...
    <table width="97%" border="0" cellspacing="5" cellpadding="5">
      <tr>
        ...
        <strong>Safe Corrugated Containers Pvt. Ltd</strong>.,</p>
          <p>No. 12-15, Gopal Reddy Kandigai, Gummidipoondi,<p />Chennai - 601 201, Tamil Nadu, India
          <p>Email ID: marketing@hexsa.in</p>
          <p>Phone: (044)-27923454</p>
...
<div id=smsinner>
 <span id="desc" style="color:#685575;"> * Describe your requirement</span>  <br />
 
  		From: <input type="text" id="from" name="from" onkeypress = "return isnumberkey(event)"/> <br />
      ...
      <tr>
        ...
        <td colspan="2"><textarea name="message" id="message" class="txtarea" cols="45"style="resize:none;"rows="5"></textarea></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
