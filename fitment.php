...
<div id="container">
  ...
  <div class="contactus">
    ...
    <p>* Honeycomb fitments are ideal Eco-friendly replacement to EPS (Thermocol) offering excellent
	<p>&nbsp;&nbsp; cushioning as well and load bearing properties.</p>
       * Unlike polystyrene our fitments are 100% <?php include "animated.php"; ?>.
    <p>* Can be die cut into various profiles.</p>
    <table width="30%" border="0" cellspacing="5" cellpadding="5">
          <tr>
            <th scope="row"><img src="../image/diepunch.png" width="231" height="192" /></th>
            <td><img src="../image/fitments.png" width="231" height="192" /></td>
            
            <td><img src="../image/automotive2.jpg" width="231" height="192" /></td>
