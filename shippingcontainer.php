...
<div id="container">
  ...
  <div class="contactus">
    ...
    <p>* Heavy duty cartons capable of handling loads upto 2 tons.</p>
    <p>* The containers can be fitted with integrated honeycomb pallet.</p>
    ...
    <p>&nbsp;</p>
        <table width="80%" border="0" cellspacing="5" cellpadding="5">
          <tr>
            <th scope="row"><img src="../image/Boxes.png" width="300" height="210" /></th>
            <td width="10%">&nbsp; </td>
            <td><img src="../image/intergratedpallet.png" width="309" height="217" /></td>
          </tr>
        </table>
